...
#define	LCD_RST PAout(0)  //LCD背光    		 RESET
#define	LCD_CS  PAout(1)  //LCD背光    		 CS
#define	LCD_RS  PAout(2) //LCD背光    		 RS
#define	LCD_WR  PAout(3) //LCD背光    		 WR
#define	LCD_RD  PAout(4) //LCD背光    		 RD
